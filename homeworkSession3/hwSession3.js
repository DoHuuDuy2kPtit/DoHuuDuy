...
// let squenceNumber = prompt("Enter a squence number, separated by commas"); //sequence chứ ko phải squence nhé n :)
//
...
// let squenceNames = prompt("Enter a squence of names");//Nên cho ng dùng biết các số phân tách bởi dấu gì(separator)?
//
